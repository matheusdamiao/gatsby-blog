...
const Footer = () => {
  return (
    <div style={{background: 'rgba(224, 203, 225, 0.5)', width:'100%', height:'400px', display: 'flex', alignItems: 'center', justifyContent: 'center', flexDirection: 'column', marginTop: '50px'}}>
     <StaticImage 
        src="../images/logo.png"
        alt='logo'
